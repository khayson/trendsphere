...
<section class="mb-12">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('blog.index', ['sort' => 'latest']) }}" class="text-red-600 dark:text-red-500 text-sm font-medium hover:text-red-700">View All Latest →</a>
    </div>
    ...
    @if($latestPosts->isEmpty())
        <div class="text-center py-8 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No latest news</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Check back soon for new updates.</p>
        </div>
    @else
