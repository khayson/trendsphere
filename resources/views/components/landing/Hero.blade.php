<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 group">
            <a href="{{ route('blog.show', ['slug' => 'record-breaking-stunning-performance']) }}" class="block">
        ...
        <div class="space-y-2">
            <!-- News Item 1 -->
            <a href="{{ route('blog.show', ['slug' => 'quiet-moment-crowd-study']) }}" class="flex gap-2 group">
            ...
            <!-- News Item 2 -->
            <a href="{{ route('blog.show', ['slug' => 'romania-bulgaria-schengen']) }}" class="flex gap-2 group">
                <div class="aspect-[4/3] w-48 overflow-hidden rounded-lg flex-shrink-0">
                    <img
                        src="https://placehold.co/400x300"
                        alt="News Item"
            ...
            <!-- News Item 3 -->
            <a href="{{ route('blog.show', ['slug' => 'emerging-markets-growth']) }}" class="flex gap-2 group">
                <div class="aspect-[4/3] w-48 overflow-hidden rounded-lg flex-shrink-0">
                    <img
                        src="https://placehold.co/400x300"
                        alt="News Item"
