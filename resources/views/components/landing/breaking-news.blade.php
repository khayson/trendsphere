...
<section class="mb-12">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white">Breaking News</h2>
        <a href="{{ route('blog.index', ['breaking' => true]) }}" class="text-red-600 dark:text-red-500 text-sm font-medium hover:text-red-700">View All Breaking News →</a>
    </div>
    ...
    @if($breakingPosts->isEmpty())
        <div class="text-center py-8 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Check back later for breaking news updates.</p>
        </div>
    @else
