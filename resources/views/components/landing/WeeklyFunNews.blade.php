<section class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Fun News Card 1 -->
                <a href="{{ route('blog.show', ['slug' => 'robot-learns-dad-jokes']) }}" class="flex gap-6 group">
                    <div class="aspect-square w-32 sm:w-48 overflow-hidden rounded-lg flex-shrink-0">
                        <img
                            src="https://placehold.co/400x400"
                            alt="Robot Telling Dad Jokes"
                ...
                <!-- Fun News Card 2 -->
                <a href="{{ route('blog.show', ['slug' => 'office-plant-survival-guide']) }}" class="flex gap-6 group">
                    <div class="aspect-square w-32 sm:w-48 overflow-hidden rounded-lg flex-shrink-0">
                        <img
                            src="https://placehold.co/400x400"
                            alt="Office Plant Guide"
                            class="object-cover w-full h-full group-hover:scale-105 transition-transform duration-500"
                        >
                    </div>
                    <div class="flex-1 space-y-3">
                        ...
                        <h3 class="font-semibold text-gray-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors line-clamp-2 text-lg">
                            Office Plant Survival Guide: From Neglect to Success
                        </h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-3">
                            A humorous take on keeping your desk plants alive, featuring real stories of plant resurrection.
                        </p>
                        <div class="flex items-center text-gray-500 dark:text-gray-400 text-sm">
