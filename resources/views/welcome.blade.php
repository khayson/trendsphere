    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section class="mb-12">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="#" class="text-red-600 dark:text-red-500 text-sm font-medium hover:text-red-700">View All Videos →</a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group">
                    ...
                    <div class="space-y-2">
                        <h3 class="font-semibold text-gray-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors line-clamp-2">
                            Behind the Scenes: The Making of Modern Architecture
                        </h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                            Explore the innovative design process and sustainable practices in contemporary architecture.
                        </p>
                        <div class="flex items-center text-gray-500 dark:text-gray-400 text-sm">
                            <span>10K views</span>
                            <span class="mx-2">•</span>
                ...
                <div class="group">
                    <div class="relative aspect-video overflow-hidden rounded-lg mb-3">
                        ...
                        <span class="absolute bottom-2 right-2 bg-black/70 text-white text-xs px-2 py-1 rounded">08:32</span>
                    </div>
                    <div class="space-y-2">
                        <h3 class="font-semibold text-gray-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors line-clamp-2">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                            Examining the latest developments in sustainable energy solutions worldwide.
                        </p>
                        <div class="flex items-center text-gray-500 dark:text-gray-400 text-sm">
                ...
                <div class="group">
                    ...
                    <div class="space-y-2">
                        <h3 class="font-semibold text-gray-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors line-clamp-2">
                            Tech Innovation: The Next Generation of Mobile Devices
                        </h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                            A deep dive into upcoming mobile technology and its impact on daily life.
                        </p>
                        <div class="flex items-center text-gray-500 dark:text-gray-400 text-sm">
                            <span>15K views</span>
                            <span class="mx-2">•</span>
